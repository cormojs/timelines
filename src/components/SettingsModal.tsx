...
export default function SettingsModal({
  ...
  const saveScaleSections = (editable = []) => {
    ...
    editable.forEach((item, index) => {
      ...
      const ordered =
        startVal < endVal ? { start: startVal, end: endVal, scale } : { start: endVal, end: startVal, scale };
  ...
  useEffect(() => {
    if (timelineData?.file) {
      ...
      if (!isNewFile) {
        setPanelGroupMode(
          timelineData.file.panelGroupMode || (timelineData.file.useEraGroupsInPanel ? 'eras' : 'default'),
        );
        ...
        setUseCalendar(
          Boolean(timelineData.file.useCalendar ?? timelineData.file.useDays ?? timelineData.file.useMonths),
        );
        ...
        setLogScaleFactor(
          Number.isFinite(Number(timelineData.file.logScaleFactor)) && Number(timelineData.file.logScaleFactor) >= 1
            ? Number(timelineData.file.logScaleFactor)
            : 10,
        );
        ...
        if (rawWidth == null && timelineData.file.compactEvents) {
          rawWidth = 130;
          rawFontSize = 7;
        }
  ...
  useEffect(() => {
    ...
    saveTimeoutRef.current = setTimeout(() => {
      ...
      const startValue =
        useCalendar && parsedStart.precision !== 'day' ? snapToMonthGrid(parsedStart.value) : parsedStart.value;
      const endValue =
        useCalendar && parsedEnd.precision !== 'day' ? snapToMonthGrid(parsedEnd.value) : parsedEnd.value;
  ...
  const fontNames = Array.from<string>(
    new Set((fonts || []).map((font) => font?.name?.trim()).filter((name): name is string => Boolean(name))),
    ...
    >
      <div className="settings-modal">
        <div className="settings-header">
          <button className="settings-back-button" onClick={handleClose} aria-label="Close settings">
        ...
        {(renameErrorMessage || validationErrors.length > 0) && (
          <div className="settings-errors">
            {renameErrorMessage && <div className="settings-error">{renameErrorMessage}</div>}
              ...
              <>
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">Open global settings for themes and files.</div>
                  </div>
                  <div className="settings-row-right">
                    <button type="button" className="settings-folder-button" onClick={onOpenAppSettings}>
                      Open App Settings
                    </button>
                  </div>
                </div>
                ...
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      Your file will be saved as: {sanitizeTitle(title) || 'untitled'}.timeline
                    </div>
                  </div>
                  <div className="settings-row-right">
                    <input
                ...
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      Control how many tick marks appear on the timeline axis.
                    </div>
                  </div>
                  <div className="settings-row-right">
                    <div className="settings-slider-wrap">
                      ...
                      {showTickDensityTooltip && (
                        <div className="settings-slider-tooltip" style={{ left: tickDensityTooltipLeft }}>
                          {tickDensity}x
                        </div>
                      )}
                      <div className="settings-slider-labels">
                ...
                {scaleType === 'logarithmic' && (
                  <div className="settings-row">
                    <div className="settings-row-left">
                      ...
                      <div className="settings-row-description">
                        Controls the strength of the logarithmic curve. Higher values compress recent time more.
                      </div>
                    </div>
                    <div className="settings-row-right">
                      <input
                ...
                {scaleType !== 'logarithmic' && (
                  <div className="settings-row settings-row-scale-sections">
                    <div className="settings-row-left">
                      ...
                      <div className="settings-row-description">Squish or stretch spans of time.</div>
                    </div>
                    <div className="settings-row-right settings-scale-sections-container">
                        ...
                        <div key={index} className="settings-scale-section-row-wrap">
                          <div className="settings-scale-section-row">
                            ...
                            <button
                              ...
                              onClick={() =>
                                updateScaleSection(index, 'showBreak', section.showBreak === false ? true : false)
                              }
                      ...
                      <button type="button" className="settings-scale-section-add" onClick={addScaleSection}>
                        <Plus size={14} />
              ...
              <>
                  ...
                  <div className="settings-row-right">
                    <div className="settings-folder settings-folder-column">
                      ...
                      {themeMigrationStatus?.count != null ? (
                        ...
                        <div className="theme-migration-notice">
                          <span>
                            {oldFormatThemeCount} theme{oldFormatThemeCount === 1 ? '' : 's'} are using an older format.
                            Update all?
                          </span>
                          <button
                            type="button"
                ...
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      Display subtle vertical grid lines aligned with tick marks.
                    </div>
                  </div>
                  <div className="settings-row-right">
                ...
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      Control the size of event boxes ({eventWidth}px{eventWidth === 150 ? '' : ' · default: 150'}).
                    </div>
                  </div>
                ...
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      Control the text size inside event boxes ({eventFontSize}px
                      {eventFontSize === 10 ? '' : ' · default: 10'}).
                    </div>
                  </div>
                  <div className="settings-row-right" style={{ minWidth: 120 }}>
                    <input
                ...
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      Lock all events to a single-line height, truncating long titles with ellipsis.
                    </div>
                  </div>
                  <div className="settings-row-right">
                    <label className="settings-toggle">
                ...
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      Use thin-style span connectors with rounded endpoints.
                    </div>
                  </div>
                  <div className="settings-row-right">
                    <label className="settings-toggle">
                ...
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      Tint event backgrounds to match their parent span's color.
                    </div>
                  </div>
                  <div className="settings-row-right">
                    <label className="settings-toggle">
                ...
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      Use the same background color as the side panels for the timeline area.
                    </div>
                  </div>
                  <div className="settings-row-right">
                    <label className="settings-toggle">
              ...
              <>
                ...
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      Enable attaching MediaWiki articles to timeline elements.
                    </div>
                  </div>
                  <div className="settings-row-right">
                    <label className="settings-toggle">
                      <input type="checkbox" checked={useWiki} onChange={(e) => setUseWikipedia(e.target.checked)} />
                      <span className="settings-toggle-slider"></span>
                    </label>
                  </div>
                </div>
                ...
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      How month and day dates are shown and typed across all panels.
                    </div>
                  </div>
                  <div className="settings-row-right">
                    <select
                ...
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      Hide branch and merge connectors between spans. Data is preserved — re-enabling this will restore
                      them.
                    </div>
                  </div>
                  <div className="settings-row-right">
                ...
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      Show month and day labels on ticks and element dates. Day-level ticks appear automatically on
                      short timelines.
                    </div>
                  </div>
                  <div className="settings-row-right">
                ...
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      Anchor unparented event lines to their group band instead of the main timeline.
                    </div>
                  </div>
                  <div className="settings-row-right">
                    <label className="settings-toggle">
                ...
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      Flatten all elements into a single group and hide group bands.
                    </div>
                  </div>
                  <div className="settings-row-right">
                    <label className="settings-toggle">
                ...
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      Hide groups that contain no events or spans from the timeline, so they take up no space instead of
                ...
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      Keep the last selected element selected when clicking the timeline background.
                    </div>
                  </div>
                  <div className="settings-row-right">
                    <label className="settings-toggle">
                ...
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      Show a row of the most-used tags at the top of the left panel for quick filtering.
                    </div>
                  </div>
                  <div className="settings-row-right">
                    <label className="settings-toggle">
              ...
              <>
                <div className="settings-row">
                  <div className="settings-row-left">
                    ...
                    <div className="settings-row-description">
                      Custom map tile URL. Use {'{z}'}, {'{x}'}, {'{y}'} as placeholders. Leave blank to use
                      OpenStreetMap.
                    </div>
                  </div>
                  <div className="settings-row-right">
